...
var AfsprakenService = /** @class */ (function () {
    ...
    AfsprakenService.prototype.logIn = function (password, username) {
    ...
    AfsprakenService.prototype.getAfspraak = function () {
        return this.http.get('/get', httpOptions);
    };
    AfsprakenService.prototype.deleteAfspraak = function (afspraak) {
        return this.http.post('/delete', { afspraak: afspraak });
    };
    AfsprakenService.prototype.gegevens_doorsturen = function (gegevens) {
        console.log(gegevens);
        return this.http.post('/formulier', gegevens);
    };
    AfsprakenService.prototype.tijden_ophalen = function (datum) {
        // console.log(datum);
        return this.http.post('/tijd', { datum: datum }, httpOptions);
    };
...
module.exports = "<h3>Plan uw afspraak in</h3>\n<div class=\"container\">\n  <form>\n    <div class=\"row\">\n      <div class=\"col-md-4 col-md-offset-2 col-sm-6\">\n        <h5>Selecteer een datum *</h5>\n        \n\n        <my-date-picker [options]=\"myDatePickerOptions\" [selDate]=\"selDate\"\n                (dateChanged)=\"onDateChanged($event)\"></my-date-picker>\n\n\n\n\n<!--         <div id=\"datepicker\" class=\"datepickermax\"></div>\n -->       \n\n        <h5>Selecteer een tijd *</h5>\n        <div class=\"keuze_tijd\" *ngIf=\"tijden.length; else other_content\">\n          <label class=\"tijd\" *ngFor=\"let tijd of tijden; let idx = index\">\n            <input type=\"radio\" value=\"{{tijd}}\" name=\"tijd\" [checked]=\"idx === 0\">\n            <span class=\"checkmark\">{{tijd}}</span>\n          </label>\n        </div>\n        <ng-template #other_content>\n          <p>Geen tijden beschikbaar</p>\n        </ng-template>\n      </div>\n      <div class=\"col-md-4 col-sm-6\">\n        <h5>Reden afspraak *</h5>\n        <div class=\"row\">\n          <div class=\"col-sm-6\">\n            <div class=\"radio\">\n              <label>\n                <input type=\"radio\" name=\"reden\" value=\"Reparatie\">Reparatie\n              </label>\n            </div>\n            <div class=\"radio\">\n              <label>\n                <input type=\"radio\" name=\"reden\" value=\"Laptops bezichtigen\" checked>Laptops bezichtigen\n              </label>\n            </div>\n          </div>\n          <div class=\"col-sm-6\">\n            <div class=\"radio\">\n              <label>\n                <input type=\"radio\" name=\"reden\" value=\"Computerhulp\">Computerhulp\n              </label>\n            </div>\n            <div class=\"radio\">\n              <label>\n                <input type=\"radio\" name=\"reden\" value=\"Overig\">Overig\n              </label>\n            </div>\n          </div>\n\n        </div>\n        <h5>Naam *</h5>\n        <input type=\"text\" name=\"name\" id=\"name\" required class=\"form\" [(ngModel)]=\"naam\" />\n        <h5>Email *</h5>\n        <input type=\"email\" name=\"mail\" id=\"mail\" required class=\"form\" [(ngModel)]=\"mail\" />\n        <h5>Telefoonnummer *</h5>\n        <input type=\"text\" name=\"mail\" id=\"telefoonnummer\" required class=\"form\" [(ngModel)]=\"tel\" />\n        <h5>Opmerkingen</h5>\n        <textarea name=\"opmerkingen\" id=\"opmerkingen\" class=\"opmerkingen\" [(ngModel)]=\"opmerkingen\"></textarea>\n      \n        <p class=\"error\">{{error}}</p>\n        <button type=\"submit\" class=\"eindknop\" (click)='ophalen_gegevens()'>Afspraak inplannen</button>\n      </div>\n    </div>\n  </form>\n</div>\n"

/***/ }),

/***/ "./src/app/klant/klant.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return KlantComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
...
var KlantComponent = /** @class */ (function () {
    ...
    KlantComponent.prototype.ngOnInit = function () {
        ...
        this.datum = __WEBPACK_IMPORTED_MODULE_2_moment__(d.getFullYear() + "-" + month + "-" + d.getDate(), "YYYY-MM-DD").format("YYYY-MM-DD");
        self.getTijden(this.datum);
    };
    KlantComponent.prototype.ophalen_gegevens = function () {
        var _this = this;
        var tijd = document.querySelector('input[name="tijd"]:checked');
        var naam = this.naam;
        var mail = this.mail;
        var tel = this.tel;
        ...
        if (naam && mail && tel && tijd) {
            ...
            this.afsprakenService.gegevens_doorsturen(gegevens).subscribe(function (response) {
                // console.log(response);
                _this.router.navigate(['/succes']);
            });
            console.log(gegevens);
        }
        else {
...
module.exports = "<div *ngIf=\"loggedIn\">\n\t<div class=\"row\">\n\t\t<div class=\"col-sm-4 col-sm-offset-4\">\n\t\t\t<form>\n\t\t\t\t<h3>Log hier in om op de admin pagina te komen</h3>\n\t\t\t\t<div class=\"form-group\">\n\t\t\t\t\t<label for=\"exampleInputEmail1\">Gebruikersnaam</label>\n\t\t\t\t\t<input [(ngModel)]=\"username\" type=\"text\" class=\"\" id=\"exampleInputEmail1\" placeholder=\"Voer gebruikersnaam in\" name=\"username\" required>\n\t\t\t\t</div>\n\n\t\t\t\t<div class=\"form-group\">\n\t\t\t\t\t<label for=\"exampleInputPassword1\">Wachtwoord</label>\n\t\t\t\t\t<input [(ngModel)]=\"password\" type=\"password\" class=\"\" id=\"exampleInputPassword1\" placeholder=\"Wachtwoord\" name=\"password\" required>\n\t\t\t\t</div>\n\n\t\t\t\t<p class=\"error\">{{error}}</p>\n\n\t\t\t\t<button (click)=\"getInlog()\">Inloggen</button>\n\n\t\t\t</form>\n\n\n\t\t</div>\n\t</div>\n</div>\n"
...
module.exports = "\n<div class=\"midden\">\n<i class=\"fas fa-calendar-check\" style=\"font-size:100px;color:#207164\"></i>\n</div>\n\n<h1>Gelukt!</h1>\n\n<p>U ontvangt een mail met de afspraakbevestiging. <br>\n</p>\n\n<a (click)=homepage()><p>Terug naar de homepage</p></a>"
